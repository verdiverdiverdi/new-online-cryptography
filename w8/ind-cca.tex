...
\node[] (Otext) at (12,4.5) {(access throughout.)};
\node[] (O) at (11.5,4) {$c \gets \Enc(pk,m)$};

\draw[->,thick] (4,4.5) -- (10,4.5) node[midway,above] {$m$};
\draw[<-,thick] (4,4) -- (10,4) node[midway,above] {$c$};
...
\node[] (Enc) at (12,0) {$c_b \gets \Enc(k,m_0)$};

\node[] (B0) at (11,-.5) {\textbf{if} $b=1:$};
\node[] (Enc) at (12,-1) {$c_b \gets \Enc(k,m_1)$};
